...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header { background: linear-gradient(145deg, #171720 0%, #0e0e11 100%); color: #ffffff; padding: 40px 20px; text-align: center; position: relative; overflow: hidden; border-bottom: 1px solid rgba(0,255,0,0.20); }
        ...
        .button { display: inline-block; background: #00ff00; color: #050507; font-weight: 700; padding: 14px 36px; border-radius: 8px; text-decoration: none; font-size: 16px; box-shadow: 0 4px 14px rgba(0,255,0,0.30); transition: all 0.2s; }
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="expiry-warning">
                <strong>⏱️ Importante:</strong> Este enlace expira en <span class="highlight-text">60 minutos</span>. Si el enlace ha expirado, puedes solicitar uno nuevo desde la página de inicio de sesión.
            </div>
