                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td style="background-color: #161c16; border-left: 4px solid #00ff00; padding: 15px; margin: 20px 0; border-radius: 4px; font-size: 13px; color: #d2d4d2; line-height: 1.5;">
                            <strong>⏱️ Importante:</strong> Este enlace expira en <span style="color: #00ff00;">60 minutos</span>. Si el enlace ha expirado, puedes solicitar otro en la página de recuperación de contraseña.
                        </td>
                    </tr>
                    <tr>
