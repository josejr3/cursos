		...
		<div class="grid grid-cols-1 gap-8 md:grid-cols-3 md:items-start">
			...
			<div class="flex flex-col items-center md:items-end gap-4">
				<div class="flex items-center gap-2">
					...
					<a href="https://www.tiktok.com" target="_blank" rel="noopener noreferrer" class="inline-flex h-9 w-9 items-center justify-center rounded-full border border-white/15 bg-white/5 text-gray-300 hover:text-[#00FF00] hover:border-[#00FF00]/40 transition-colors" aria-label="TikTok">
						<svg class="h-4 w-4" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
							<path d="M14.5 3c.2 1.8 1.3 3.3 3 3.8v2.2c-1.2 0-2.4-.4-3.4-1.1v5.2a4.8 4.8 0 1 1-4.8-4.8c.3 0 .5 0 .8.1v2.4a2.4 2.4 0 1 0 1.6 2.3V3h2.8z"/>
						</svg>
					</a>
